...
int main(void)
{
  ...
  osThreadDef(Sender, Tx, osPriorityNormal, 0, 128);
  SenderHandle = osThreadCreate(osThread(Sender), NULL);

  /* definition and creation of Reciver */
  osThreadDef(Reciver, Rx, osPriorityNormal, 0, 128);
  ReciverHandle = osThreadCreate(osThread(Reciver), NULL);
...
/**
* @brief Function implementing the Reciver thread.
* @param argument: Not used
* @retval None
*/
